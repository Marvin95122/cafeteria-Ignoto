...
<div class="flex items-center gap-4 mb-8">
    ...
    <div>
        <h1 class="font-serif text-3xl font-bold text-amber-900">Editar Categoría</h1>
        <p class="text-stone-500">Modificando: <span class="font-semibold">{{ $category->name }}</span></p>
    </div>
</div>
            ...
            <form method="POST" action="{{ route('categories.update', $category) }}">
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex items-center gap-3 bg-stone-50 p-4 rounded-lg border border-stone-200">
                        ...
                        <label for="active" class="font-medium text-stone-700 cursor-pointer">
                            Categoría Activa (Visible en menú)
                        </label>
                    </div>
                </div>
