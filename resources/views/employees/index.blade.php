    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5">
        <div class="bg-white p-5 rounded-2xl shadow-sm border border-stone-200 hover:shadow-md transition">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-bold text-stone-500">Usuarios registrados</p>
        ...
        <div class="bg-white p-5 rounded-2xl shadow-sm border border-stone-200 hover:shadow-md transition">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-bold text-stone-500">Administración</p>
                    <h3 class="text-3xl font-black text-purple-600 mt-1">
        ...
        <form method="GET" action="{{ route('employees.index') }}" class="space-y-4">
            <div class="flex flex-col xl:flex-row gap-4 items-center">
                ...
                <select name="status"
                        ...
                        class="w-full xl:w-52 rounded-xl border-stone-200 bg-stone-50 text-stone-700 shadow-sm focus:border-amber-500 focus:ring focus:ring-amber-200 focus:ring-opacity-50 transition py-3">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
        @forelse($employees as $employee)
            <div class="bg-white rounded-2xl shadow-sm border border-stone-100 p-6 flex items-start gap-4 hover:shadow-md transition relative group
                ...
                <div class="h-16 w-16 rounded-full flex items-center justify-center text-2xl font-black shadow-inner shrink-0
                ...
                <div class="flex-1 min-w-0">
                    <h3 class="font-bold text-lg text-stone-800 leading-tight truncate">
                        {{ $employee->name }}
                    </h3>

                    <p class="text-sm text-stone-500 mb-3 truncate">
                        {{ $employee->email }}
                    </p>
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        @else
                            <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-bold bg-stone-200 text-stone-600 border border-stone-300">
                                Inactivo
                            </span>
                        @endif
        ...
        @empty
            <div class="xl:col-span-3 md:col-span-2 col-span-1 text-center py-14 bg-white rounded-2xl border border-dashed border-stone-300">
